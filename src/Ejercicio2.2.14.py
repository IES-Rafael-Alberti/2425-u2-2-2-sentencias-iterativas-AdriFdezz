...
def obtenerNumeros() -> list:
    """
    Obtiene una lista de numeros enteros del usuario hasta que se ingrese 0.
...
def procesarNumeros(numeros: list) -> int:
    """
    Procesa los numeros ingresados y retorna la suma.
...
def mostrarResultado(suma: int):
    ...
    Args:
        suma (int): La suma de los numeros.
    """
